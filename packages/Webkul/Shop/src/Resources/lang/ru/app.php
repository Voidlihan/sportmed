...
return [
    'customers' => [
        ...
        'account' => [
            ...
            'orders' => [
                ...
                'empty-order'   => 'Вы еще не заказывали ни одной услуги',
                'order'         => 'Заказ',
                ...
                'view' => [
                    ...
                    'contact'              => 'Контакт',
                    'item-invoiced'        => 'Услуга выставлена в счет',
                    'item-refunded'        => 'Услуга возвращена',
                    'item-shipped'         => 'Услуга отправлена',
                    'item-ordered'         => 'Услуга заказана',
                    'order-id'             => 'ID заказа',
                    ...
                    'invoices' => [
                        ...
                        'print'                      => 'Печать',
                        'product-name'               => 'Название',
                        'products-ordered'           => 'Заказанные услуги',
                        'qty'                        => 'Кол-во',
                        'shipping-handling-excl-tax' => 'Доставка и обработка (без налога)',
                        'shipping-handling-incl-tax' => 'Доставка и обработка (с налогом)',
                        'shipping-handling'          => 'Доставка и обработка',
            ...
            'downloadable-products' => [
                ...
                'expired'             => 'Истек',
                'empty-product'       => 'У вас нет услуг для загрузки',
                'name'                => 'Услуги для скачивания',
                'orderId'             => 'ID заказа',
                'pending'             => 'В ожидании',
            ...
            'wishlist' => [
                ...
                'empty'              => 'На странице списка желаемого еще нет услуг.',
                'move-to-cart'       => 'Переместить в корзину',
                'moved'              => 'Услуга успешно перемещена в корзину',
                'moved-success'      => 'Услуга успешно перемещена в корзину',
                'page-title'         => 'Список желаемого',
                'product-removed'    => 'Услуга больше не доступна, так как был удален администратором',
                'profile'            => 'Профиль',
                'remove'             => 'Удалить',
                'remove-all-success' => 'Все услуги из вашего списка желаемого были удалены',
                'remove-fail'        => 'Услуга не может быть удалена из списка желаемого',
                'removed'            => 'Услуга успешно удалена из списка желаемого',
                'see-details'        => 'Подробнее',
                'success'            => 'Услуга успешно добавлена в список желаемого',
    ...
    'components' => [
            ...
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile'       => 'Профиль',
                        'search'        => 'Поиск',
                        'search-text'   => 'Искать услуги здесь',
                        'sign-in'       => 'Войти',
        ...
        'products' => [
            'card' => [
                ...
                'add-to-compare-success' => 'Услуга успешно добавлена в список сравнения.',
                'add-to-wishlist'        => 'Добавить в Список Желаемого',
                'already-in-compare'     => 'Услуга уже добавлена в список сравнения.',
                'new'                    => 'Новинка',
                'review-description'     => 'Будьте первым, кто оставит отзыв об услуге',
                'sale'                   => 'Распродажа',
            ],
    ...
    'products' => [
        ...
        'view' => [
            ...
            'gallery' => [
                'product-image'   => 'Изображение услуги',
            ...
            'reviews' => [
                ...
                'empty-review'     => 'Отзывов не найдено, будьте первым, кто оставит отзыв об услуге',
            ...
            'add-to-cart'            => 'Добавить в корзину',
            'add-to-compare'         => 'Услуга добавлена в список сравнения.',
            'add-to-wishlist'        => 'Добавить в Список Желаемого',
            ...
            'related-product-title'  => 'Связанные услуги',
            'review'                 => 'Отзывы',
            'tax-inclusive'          => 'Включая все налоги',
            'up-sell-title'          => 'Мы нашли другие услуги, которые вам могут понравиться!',
        ],
        ...
        'booking' => [
            ...
            'cart'             => [
                ...
                'integrity'    => [
                    ...
                    'missing_options'        => 'Отсутствуют варианты для этой услуги.',
    ...
    'categories' => [
        ...
        'view' => [
            'empty'     => 'В этой категории нет доступных услуг',
            'load-more' => 'Загрузить еще',
        ],
    ],
    ...
    'compare' => [
        'already-added'      => 'Услуга уже добавлена в список сравнения',
        'delete-all'         => 'Удалить все',
        'empty-text'         => 'У вас нет услуг в списке сравнения',
        'item-add-success'   => 'Услуга успешно добавлена в список сравнения',
        'product-compare'    => 'Сравнение услуг',
        'remove-all-success' => 'Все услуги успешно удалены.',
        'remove-error'       => 'Что-то пошло не так. Попробуйте еще раз позже.',
        'remove-success'     => 'Услуга успешно удалена.',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'inactive-add'              => 'Неактивная услуга не может быть добавлена в корзину.',
            'inactive'                  => 'Услуга была деактивирована и удалена из корзины.',
            'inventory-warning'         => 'Запрошенное количество услуг недоступно. Попробуйте позже.',
            'item-add-to-cart'          => 'Услуга успешно добавлена',
            'minimum-order-message'     => 'Минимальная сумма заказа составляет',
            'missing-fields'            => 'Отсутствуют некоторые обязательные поля для этой услуги.',
            'missing-options'           => 'Отсутствуют варианты для этой услуги.',
            'paypal-payment-cancelled'  => 'Платеж через PayPal был отменен.',
            'qty-missing'               => 'Как минимум одна услуга должна иметь количество больше 1.',
            ...
            'success-remove'            => 'Услуга успешно удалена из корзины.',
            ...
            'index' => [
                ...
                'empty-product'            => 'В вашей корзине нет услуг.',
                'excl-tax'                 => 'Без учета налога:',
                'home'                     => 'Главная',
                'items-selected'           => ':count услуг выбрано',
                'move-to-wishlist'         => 'Переместить в список желаний',
                'move-to-wishlist-success' => 'Выбранные услуги успешно перемещены в список желаний.',
                'price'                    => 'Цена',
                'product-name'             => 'Название услуги',
                'quantity'                 => 'Количество',
                'quantity-update'          => 'Количество успешно обновлено',
                'remove'                   => 'Удалить',
                'remove-selected-success'  => 'Выбранные услуги успешно удалены из корзины.',
                'see-details'              => 'Подробнее',
                'select-all'               => 'Выделить все',
                'select-cart-item'         => 'Выбрать услугу в корзине',
                'tax'                      => 'Налог',
                'total'                    => 'Итого',
    ...
    'home' => [
        ...
        'index' => [
            ...
            'product-carousel'    => 'Карусель услуг',
    ...
    'layouts' => [
        'address'               => 'Адрес',
        'downloadable-products' => 'Загружаемые услуги',
